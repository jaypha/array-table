...
class CustomArray implements Iterator , ArrayAccess  , Countable {
  use Jaypha\JoinTrait;
  protected $a = [];
  ...
  public function offsetExists($offset): bool { return array_key_exists($offset, $this->a); }
...
class CustomArrayTest extends TestCase
{
  protected $table1, $table2, $table3;

  function setUp()
  {
    $this->table1 = new CustomArray([
      new CustomArray(['a' => 10, 'b' => 20,'c' => 30,'d' => 40]),
      ['a' => 11, 'b' => 16,'c' => 31,'d' => 41],
      new CustomArray(['a' => 11, 'b' => 28,'c' => 31,'d' => 41]),
      ['a' => 12, 'b' => 30,'c' => 31,'d' => 41],
      new CustomArray(['a' => 15, 'b' => 42,'c' => 31,'d' => 41])
    ]);

    $this->table2 = [
      ['e' => 100, 'f' => 12, 'j' => 44 ],
      new CustomArray(['e' => 101, 'f' => 13, 'j' => 344 ]),
      ['e' => 310, 'f' => 10, 'j' => 44 ],
      new CustomArray(['e' => 410, 'f' => 11, 'j' => 10 ]),
      ['e' => 510, 'f' => 10, 'j' => 45 ],
    ];

    $this->table3 = new CustomArray([
      ['d' => 100, 'f' => 12, 'j' => 54 ],
      new CustomArray(['d' => 101, 'f' => 13, 'j' => 344 ]),
      ['d' => 310, 'f' => 10, 'j' => 44 ],
      new CustomArray(['d' => 410, 'f' => 11, 'j' => 10 ]),
      ['d' => 510, 'f' => 10, 'j' => 45 ],
    ]);
  }
  ...
  {
    $newTable = new CustomArray([
      new CustomArray(['a' => 10,'c' => 30,'d' => 40]),
      ['a' => 11,'c' => 31,'d' => 41],
      new CustomArray(['a' => 11,'c' => 31,'d' => 41]),
      ['a' => 12,'c' => 31,'d' => 41],
      new CustomArray(['a' => 15,'c' => 31,'d' => 41])
    ]);
  ...
  {
    $newTable = new CustomArray([
      new CustomArray(['a' => 10, 'b' => 20,'c' => 30,'d' => 40, 'e' => 310, 'f' => 10, 'j' => 44]),
      new CustomArray(['a' => 10, 'b' => 20,'c' => 30,'d' => 40, 'e' => 510, 'f' => 10, 'j' => 45]),
      ['a' => 11, 'b' => 16,'c' => 31,'d' => 41, 'e' => 410, 'f' => 11, 'j' => 10],
      new CustomArray(['a' => 11, 'b' => 28,'c' => 31,'d' => 41, 'e' => 410, 'f' => 11, 'j' => 10]),
      ['a' => 12, 'b' => 30,'c' => 31,'d' => 41, 'e' => 100, 'f' => 12, 'j' => 44],
      new CustomArray(['a' => 15, 'b' => 42,'c' => 31,'d' => 41])
    ]);
    $joined = $this->table1->leftJoin($this->table2,'a','f');
    $this->assertEquals($joined, $newTable);
    $this->assertEquals($this->table1->leftJoin([],'a','f'), $this->table1);
  }
  ...
  {
    $newTable = new CustomArray([
      new CustomArray(['a' => 10, 'b' => 20,'c' => 30,'d' => 40, 'f' => 10, 'j' => 44]),
      new CustomArray(['a' => 10, 'b' => 20,'c' => 30,'d' => 40, 'f' => 10, 'j' => 45]),
      ['a' => 11, 'b' => 16,'c' => 31,'d' => 41, 'f' => 11, 'j' => 10],
      new CustomArray(['a' => 11, 'b' => 28,'c' => 31,'d' => 41, 'f' => 11, 'j' => 10]),
